...
<body>
    ...
    <div class="container mt-4">
        <h1 class="text-center">Listagem de Jogos</h1>
        <div class="d-grid gap-2 col-6 mx-auto">
            <a href="novo_jogo.php" class="btn btn-info">Criar</a>
        </div>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        <td><?php print $jogo['nome']; ?></td>
                        <td>R$ <?php print $jogo['preco']; ?></td>
                        <td>
                            <a href="detalhes_jogo.php?id=<?php print $jogo['id']; ?>" class="btn btn-info">Detalhes</a>
                            <a href="excluir_jogo.php?id=<?php print $jogo['id']; ?>" class="btn btn-danger">Excluir</a>
